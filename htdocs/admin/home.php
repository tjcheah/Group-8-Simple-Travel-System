						...
						<?php while($row = mysqli_fetch_array($town)){ ?>
							<div class="list-group-item my-2 bg-light">
								...
								<div style="float: right">
									...
									<a href="#" onclick="delete_town(<?php echo $row['town_id'] ?>)" class="btn btn-danger active mx-3" role="button" aria-pressed="true">Delete Town</a>
								</div>
							</div>
						<?php } ?>
					</div>
						...
						<?php while($row = mysqli_fetch_array($entertainment)){ ?>
							<div class="list-group-item my-2 bg-light">
								...
								<div style="float: right">
									...
									<a href="#" onclick="delete_entern(<?php echo $row['entern_id'] ?>)" class="btn btn-danger active mx-3" role="button" aria-pressed="true">Delete Entertainment</a>
								</div>
							</div>
						<?php } ?>
					</div>
						...
						<?php while($row = mysqli_fetch_array($restaurant)){ ?>
							<div class="list-group-item my-2 bg-light">
								...
								<div style="float: right">
									...
									<a href="#" onclick="delete_restaurant(<?php echo $row['restaurant_id'] ?>)" class="btn btn-danger active mx-3" role="button" aria-pressed="true">Delete Restaurant</a>
								</div>
							</div>
						<?php } ?>
					</div>
						...
						<?php while($row = mysqli_fetch_array($accommodation)){ ?>
							<div class="list-group-item my-2 bg-light">
								...
								<div style="float: right">
									...
									<a href="#" onclick="delete_accommodation(<?php echo $row['hotel_id'] ?>)" class="btn btn-danger active mx-3" role="button" aria-pressed="true">Delete Accommodation</a>
								</div>
							</div>
						<?php } ?>
					</div>
						...
						<?php while($row = mysqli_fetch_array($event)){ ?>
							<div class="list-group-item my-2 bg-light">
								...
								<div style="float: right">
									...
									<a href="#" onclick="delete_package(<?php echo $row['event_id'] ?>)" class="btn btn-danger active mx-3" role="button" aria-pressed="true">Delete Package</a>
								</div>
							</div>
						<?php } ?>
					</div>
